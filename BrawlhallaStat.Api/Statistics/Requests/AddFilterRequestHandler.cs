...
public class AddFilterRequestHandler : IRequestHandler<AddFilterRequest, StatisticWithFilter>
{
    ...
    public async Task<StatisticWithFilter> Handle(AddFilterRequest request, CancellationToken cancellationToken)
    {
